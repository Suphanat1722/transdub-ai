...
7. ความยาวคำแปลต่อ cue ต้องพูดจบได้ภายในเวลาของ cue นั้นด้วยจังหวะพูดปกติ (ประมาณ 14-16 ตัวอักษรไทยต่อวินาที) หากยาวเกินงบ ให้แปลกระชับขึ้นตามข้อ 1 ก่อน หากยังยาวเกินอยู่ค่อยแบ่งตามจังหวะความหมาย ห้ามแบ่งกลางวลี หากสั้นกว่างบเกินราวหนึ่งในสี่ ให้ใช้ถ้อยคำเต็มขึ้นจนพอดีช่องแทนการปล่อยว่าง
