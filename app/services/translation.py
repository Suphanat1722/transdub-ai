...
1. รักษาความหมาย ข้อมูล น้ำเสียง และเจตนาของต้นฉบับให้ครบถ้วน ห้ามเพิ่มข้อมูลที่ไม่มีในต้นฉบับ **แต่ให้แปลแบบกระชับสมจริงกับภาษาพูด**: ตัดคำซ้ำซ้อนหรือคำขยายที่ไม่จำเป็นได้ (เช่น "บัญชีธนาคาร" → "บัญชี" ถ้าบริบทสื่ออยู่แล้วว่าเป็นธนาคาร) เลือกคำที่สั้นกว่าแต่ความหมายเดิม — ห้ามตัดข้อเท็จจริงหรือสาระ เพียงแต่ตัดคำฟุ่มเฟือย
...
7. ความยาวคำแปลต่อ cue ต้องพูดจบได้ภายในเวลาของ cue นั้นด้วยจังหวะพูดปกติ (ประมาณ 12-15 ตัวอักษรไทยต่อวินาที) หากยาวเกิน ให้แปลกระชับขึ้นตามข้อ 1 ก่อน หากยังยาวเกินอยู่ค่อยแบ่งตามจังหวะความหมาย ห้ามแบ่งกลางวลี
...
## ตัวอย่างการแปลแบบกระชับ (ยึดเป็นมาตรฐาน)
