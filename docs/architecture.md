...
5. เมื่อครบทุก cue ระบบแบ่งซับที่ต่อเนื่องกัน (ห่างไม่เกิน 400ms) เป็นกลุ่มเสียง วางต่อกันแบบไม่มีทับ แล้วฟิตทั้งก้อนด้วย `atempo` เดียว — ยาวเกินเร่งสูงสุด 1.25x สั้นเกินช้าสุด 0.8x ให้พอดีซับ cue สุดท้ายของกลุ่ม ทุก cue ในกลุ่มจึงจังหวะเท่ากัน แต่ละกลุ่มยึดที่เวลาเริ่มซับของตัวเองหรือเสียงกลุ่มก่อนหน้าหลังฟิต (อันไหนหลังกว่า) ช่องหยุดจริงระหว่างกลุ่มถูกเก็บไว้ หากเร่งสุดแล้วยังล้นจะเก็บเสียงเต็มและแจ้งเตือน “กลุ่ม cue …” พร้อมหยุดที่ `needs_review` เมื่อเสียงรวมยาวเกินวิดีโอเกิน 2 วินาที (น้อยกว่านั้นถือเป็น slop ของ timecode: ประกอบต่อพร้อมเตือนและต่อภาพนิ่งท้ายให้)
...
ดาวน์โหลดด้วย `bv*+ba/b` ลอง client ตามลำดับ TV → web → iOS → Android โดยอันแรกที่สำเร็จชนะ (client มือถือให้คุณภาพลดจึงไว้ท้าย) ทุกไฟล์ที่โหลดได้ถูก probe ความละเอียดจริง ตัวแรกที่ถึง 720p ชนะทันที ถ้าต่ำกว่านั้นลอง client ถัดไปต่อและเก็บไฟล์ที่ดีสุดไว้ (คลิปที่ต้นฉบับต่ำอยู่แล้วไม่ถือว่าพัง) และรวมเป็น MKV เพื่อไม่ทิ้งสตรีม VP9/AV1/Opus วิดีโอจบยัง mux เป็น MP4 เหมือนเดิม ชื่องานและไฟล์ใช้ชื่อคลิป YouTube (sanitize สำหรับ Windows) ไฟล์เสร็จไปโฟลเดอร์ที่เลือก หรือ `data/outputs` (ชื่อ `{ชื่อคลิป}.th-dub.mp4`) เมื่อไม่เลือก
