...
- ค่าเริ่มต้นทํางานอัตโนมัติจนได้ MP4; เลือกพักหลัง transcript หรือ translation ได้
- หน้าเว็บให้เลือกรายการเสียง Edge TTS (เช่น `th-TH-PremwadeeNeural` หรือ `th-TH-NiwatNeural`) และอัตราการพูดได้
...
- ถ้าเสียงพากย์ยาวเกินวิดีโอ ระบบหยุดที่ `needs_review` และไม่ตัดคําพูดทิ้ง
