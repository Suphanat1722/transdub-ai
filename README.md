...
- แก้ตั้งค่างานที่สร้างแล้วได้จากการ์ด "ตั้งค่างาน": เสียง, อัตราการพูด, ระดับเสียงพื้นหลัง/พากย์ และโฟลเดอร์ส่งออก — เปลี่ยนเสียงหรืออัตราการพูดจะลบเสียงที่สร้างไว้แล้วสร้างใหม่ทั้งหมดโดยข้อความ/คำแปลคงเดิม
- ในหน้าตรวจ cue สามารถฟังเสียงพูดเดี่ยว (▶) หรือเสียงพูดผสมเสียงพื้นหลังช่วงนั้น (🎚) เพื่อตรวจความเพี้ยนก่อนยืนยันคำแปล
...
- แก้ข้อความ/timecode ในหน้าเว็บได้ ผลลัพธ์ถัดไปที่เกี่ยวข้องจะถูก invalidate และสร้างใหม่ — การแก้ฝั่งต้นฉบับจะลบคำแปลและเสียงทั้งงาน (ระบบจะถามยืนยันก่อน)
